var sessions = [
    ...
    {id:5 , title:"This is a new cool session", speaker:"KENT KORGAN", time:"12:00pm", room:"Ballroom Z", description: "Join Kent in this session to fuck shit up in Ballroom Z. Shit is gonna be wild!"}
];
